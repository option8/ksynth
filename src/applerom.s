...
HPLOT        equ   $F457       ;Plots a colored dot at the position
...
GETLN        equ   $FD6A       ; Displays the prompt character; accepts a string of characters
                               ;  by means of RDKEY (return length in X)
GETLNZ       equ   $FD67       ; Outputs CR, prompt char (specified at $33), then GETLN
GETLN1       equ   $FD6F       ; No prompt or CR version of GETLN
